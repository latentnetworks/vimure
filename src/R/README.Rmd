...
Vimure R package depends on R >= 3.3.0 and Python >= 3.6 and it is expect to work fine in all OS.
...
If you do not want to install miniconda, you can set up your [Python enviroment](http://timsherratt.org/digital-heritage-handbook/docs/python-pip-virtualenv/) manually. VIMuRe requires Python >= 3.6.
