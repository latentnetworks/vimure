...
Let's check which reporters have the highest $\theta_l \times \lambda_{k=1}$ values:
...
To verify if this is the case for our network, let's examine the top reporter listed in the table above (113302).
