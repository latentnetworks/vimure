...
theta_layer_cols = [f"theta_{layer}" for layer in model.layerNames]

theta_per_layer = pd.DataFrame(posterior_estimates['theta'].T, 
                               columns=theta_layer_cols)

df_theta_reporters = pd.concat([df_theta_reporters, theta_per_layer], axis=1)
df_theta_reporters['reporter_id'] = df_theta_reporters['reporter_id'].astype(pd.Int64Dtype())

# Sort by reliability
df_theta_reporters.sort_values(by=theta_layer_cols, ascending=False, inplace=True)
...
|   reporter_id |   reporter_name |   theta_advice |   theta_kerorice |   theta_money |   theta_visit |
|--------------:|----------------:|---------------:|-----------------:|--------------:|--------------:|
|           120 |          113302 |        1.56308 |      2.06044     |   0.99434     |      0.502956 |
|           124 |          113901 |        1.52996 |      2.28673     |   1.87973     |      1.6035   |
|            97 |          109902 |        1.48183 |      2.20819     |   3.36878e-05 |      1.53681  |
|            92 |          109505 |        1.4818  |      3.61538e-05 |   1.81555     |      2.06534  |
|            56 |          105902 |        1.48178 |      3.55888e-05 |   0.992002    |      0.895679 |
:::
