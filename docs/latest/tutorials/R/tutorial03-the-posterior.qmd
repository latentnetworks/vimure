...
categories: [basics, R]
description: "How to extract point estimates from the posterior distribution of the latent network model fitted by VIMuRe"
---
...
ggplot(rho_df, aes(x = Ego, y = Alter, fill = Value)) +
    geom_tile() +
    ...
    theme(axis.text=element_text(size=rel(1.5)),
          ...
          panel.grid.major = element_blank()) -> g
```
</details>
