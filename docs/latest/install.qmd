...
You **must** install the python package before using the R package. This is because the R package is a wrapper around the Python package. To install the Python package, follow the instructions below.
