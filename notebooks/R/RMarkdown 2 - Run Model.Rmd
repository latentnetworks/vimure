...
Let us generate a synthetic network with reciprocity (`gm_CReciprocity`):

```{r}
# Eta is the expected reciprocity on the network
random_net <- gm_CReciprocity(N=100, M=100, L=1, C=2, K=2, avg_degree=10, seed=24, sparsify=T, eta=0.2) 
